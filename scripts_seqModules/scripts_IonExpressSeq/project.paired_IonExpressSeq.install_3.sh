#!/bin/bash -e
#
# project.paired_IonExpressSeq.install_3.sh
#
set -e;
...
#chmod 0755 $logName;
echo "#.............................................................................." >> $logName;
echo "Running 'scripts_seqModules/scripts_IonExpressSeq/project.paired_IonExpressSeq.install_3.sh'" >> $logName;
echo "Variables passed via command-line from 'php/project.paired_IonExpressSeq.install_2.php' :" >> $logName;
...
then
	...
	##==============================================================================
	## Initial processing of paired-IonExpressSeq dataset.
	##------------------------------------------------------------------------------
	echo "#=========================================================#" >> $logName;
	echo "# Initial processing of paired-end IonExpressSeq dataset. #" >> $logName;
	echo "#=========================================================#" >> $logName;
	...
	then
		...
		java -Xmx2g -jar $main_dir$picardDirectory AddOrReplaceReadGroups INPUT=$projectDirectory"data.temp.bam" OUTPUT=$projectDirectory"data.bam" RGID=1 RGLB=1 RGPL=ILLUMINA RGPU=1 RGSM=SM;
