...
RUN apt-add-repository ppa:webupd8team/java \
 ...
 && apt-get update \
 && apt-get -y install build-essential libpq-dev libssl-dev openssl libtbb-dev libffi-dev zlib1g-dev libbz2-dev libncurses5-dev libncursesw5-dev liblzma-dev python3-pip python3-dev python-numpy oracle-java8-installer \
